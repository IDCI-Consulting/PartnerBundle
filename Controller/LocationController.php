...
use IDCI\Bundle\PartnerBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $entities = $em->getRepository('IDCIPartnerBundle:Location')->findAll();
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('IDCIPartnerBundle:Location')->find($id);
